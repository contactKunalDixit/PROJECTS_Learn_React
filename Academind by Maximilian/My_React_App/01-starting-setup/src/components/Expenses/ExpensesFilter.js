...
// !Note : The ExpensesFilter.js is just a component which just constitutes to the UI and presentation of the Filter functionality. Its functionality is just limited to ccapturing the 'event', when it happens.

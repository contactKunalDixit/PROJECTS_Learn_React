...
Tradionally, in web apps or web pages, you click a link and wait for a new page to load. You click a  button and wait for some action tChapter 1 to 10 - Summary ***************o complete. That's because on the backend, what the click triggers, is a request from user's end (browser in this case) and sends it to the server. The server in return, and as a response sends the new HTML file with new data.
